...
// import pic from "../static/assets/img/python.png"
          ...
          <div className ="container">
              ...
              <div className ="news_list">
                  <ul>
                      <li className ="wow fadeInUp" data-wow-duration="1s">
                          <div className ="list_inner">
                              <div className ="image">
                                  ...
                                  <a className ="dizme_tm_full_link" href="#!">goto</a>
                              </div>
                              <div className ="details">
                                  <span className ="category"><a href="#!">Web Development</a></span>
                                  <h3 className ="title"><a href="#!">Jim Morisson Says when the musics over turn off
                                          the light</a></h3>
                              </div>
                      ...
                      <li className ="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                          <div className ="list_inner">
                              <div className ="image">
                                  <img src="img/thumbs/42-29.jpg" alt="" />
                              ...
                              <div className ="details">
                                  <span className ="category"><a href="#!">Branding</a></span>
                                  <h3 className ="title"><a href="#!">How to be appreciated for your hard work as a
                                          developer</a></h3>
                              </div>
                              <div className ="news_hidden_details">
                                  <div className ="news_popup_informations">
                      ...
                      <li className ="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                          <div className ="list_inner">
                              <div className ="image">
                                  <img src="img/thumbs/42-29.jpg" alt="" />
                              ...
                              <div className ="details">
                                  <span className ="category"><a href="#!">Social Media</a></span>
                                  <h3 className ="title"><a href="#!">How designers and developers can collaborate
                                          better</a></h3>
                              </div>
                              <div className ="news_hidden_details">
                                  <div className ="news_popup_informations">
